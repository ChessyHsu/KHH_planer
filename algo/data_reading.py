...
df_port_to_pier = pd.read_excel(os.path.join(file_dir, "data/complete_dis.xlsx"),
                                index_col="代號")
# pier to pier distance
df_pier_to_pier = pd.read_excel(os.path.join(file_dir, "data/complete_dis_meter.xlsx"),
                                index_col=1)
